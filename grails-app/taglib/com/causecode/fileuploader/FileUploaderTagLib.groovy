...
class FileUploaderTagLib {
	...
	def download = { attrs, body ->
		...
		out << g.link([controller: 'file-uploader', action: 'download', params: params, id: attrs.id], body)
    ...
    sb.append g.uploadForm([controller: 'file-uploader', action: 'upload', id: attrs.id], tagBody)
